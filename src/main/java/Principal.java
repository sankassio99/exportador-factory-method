...
public class Principal {
    public static void main(String[] args) {
        ...
        ExportadorListaProduto exportadorPadrao = ExportadorListaProduto.newInstance("html");

        exportadorPadrao.addNewColuna(Principal::colunaModelo, "Modelo");

        System.out.println(exportadorPadrao.exportar(produtos));

    }

    private static String colunaModelo(Produto produto){
